...
public class AddressesContractUnitTest {

    @Test
    public void inner_class_exists() throws Exception {
        Class[] innerClasses = AddressesContract.class.getDeclaredClasses();
    ...
    public void inner_class_members_correct() throws Exception {
        ...
        for (Field field : allFields) {
            assertTrue("All members in the contract class should be Strings of Uri",
                    field.getType() == String.class || field.getType() == Uri.class);
